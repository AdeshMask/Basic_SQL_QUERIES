...
insert into empTable (Employee_Name, Phone_number,Address, Department, Gender, salary, Start_Date, city, country) values ('Adesh', '1234567890','Solapur','Engg', 'M', '30000.0', '2022-03-02', 'Pune', 'India');
insert into empTable (Employee_Name, Phone_number,Address, Department, Gender, salary, Start_Date, city, country) values ("Gunjan", "1234567890", "Mumbai", "Engg", "M", '30000.0','2022-04-05', "pune", "India");
...
select * from empTable where country = "India" AND city = "Mumbai";
Select * from empTable where country = "America" OR city = "Pune";
select * from empTable where NOT city = "Nagpur";
...
use employeedetails;
insert into Customers(CustomerId,CustomerName,country,Mobile) values('1','Adesh','India','9098789560');
insert into Customers(CustomerId,CustomerName,country,Mobile) values('2','Saurabh','America','9098456560');
insert into Customers(CustomerId,CustomerName,country,Mobile) values('3','Kiran','India','9098781234');
